...
class Javascript(BaseLanguage):
    ...
    def make_nodes(tree, parent, filename):
        ...
        subnodes = flatten([Javascript.make_nodes(t, node, filename) for t in subnode_trees])
    ...
    def make_root_node(lines, parent):
        ...
        root_node = Node(token, calls, variables, parent=parent, line_number=0)
        return root_node
    ...
    def make_class_group(tree, parent):
        ...
        for node_tree in node_trees:
            for new_node in Javascript.make_nodes(node_tree, parent=class_group, filename=None):
